...
export default function EnvironmentSelector() {
  ...
  return (
    <div className="bg-black text-white rounded shadow p-3">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-semibold text-white">Environments</h3>
        <button
      ...
      {loading ? (
        ...
        <>
          <select
            ...
            className="w-full border border-gray-600 bg-gray-900 text-white p-2 rounded mb-3"
          >
          ...
          {editingEnv ? (
            <>
              <input
                className="w-full p-2 border border-gray-600 rounded mb-2 bg-gray-900 text-white"
              ...
              <div className="space-y-2 max-h-48 overflow-auto p-1">
                {/* baseUrl */}
                <div className="flex items-center gap-2 p-2 border border-gray-700 rounded bg-gray-800 w-full min-w-0">
                  <div className="w-32 text-sm text-gray-300">baseUrl</div>
                ...
                {/* token */}
                <div className="flex items-center gap-2 p-2 border border-gray-700 rounded bg-gray-800 w-full min-w-0">
                  <div className="w-32 text-sm text-gray-300">token</div>
                  <div className="flex-1 min-w-0">
                    <input
                      className="w-full p-2 border border-gray-700 rounded bg-black text-white"
                ...
                {Object.keys(editingEnv.variables || {})
                  ...
                  .map((k) => (
                    <div
                      key={k}
                      className="flex items-center gap-2 p-2 border border-gray-700 rounded bg-gray-800 w-full min-w-0"
                    >
                      <input
                        className="w-32 p-2 border border-gray-700 rounded bg-black text-white"
                        value={k}
                        readOnly
                      />
                      <div className="flex-1 min-w-0">
                      ...
                      <button
                        className="px-2 py-1 bg-red-600 text-white rounded whitespace-nowrap"
                        onClick={() => removeVar(k)}
                      >
                        Delete
                      </button>
              ...
              {/* add var */}
              <div className="flex items-center gap-2 p-2 border border-gray-700 rounded bg-gray-800 mt-3 w-full min-w-0">
                <input
                  placeholder="key"
                  className="w-32 p-2 border border-gray-700 rounded bg-black text-white"
                  value={newVarKey}
              ...
              <div className="flex gap-2 mt-3">
                ...
                <button
                  className="px-3 py-1 bg-red-700 text-white rounded ml-auto"
